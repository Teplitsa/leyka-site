...
<ul>
 	<li>Если у вас нет разработчиков, которые могли бы это сделать, вы можете попросить об этом Теплицу социальных технологий. Для этого напишите нам в <a href="https://leyka.org/support/">поддержку</a>.</li>
...
О том, как развернуть "Лейку рядом", вы можете подробно прочитать<a href="https://leyka.org/leyka-standalone/">здесь</a>
Вкратце:
<ol>
...
<ul>
 	...
 	<li>затем загрузить и включить тему сайта "Grassroots" (пример сайта с этой темой - <a href="https://leyka.org/">официальный сайт Лейки</a> или<a href="http://donate.perspektiva-inva.ru/">краудфандинговый сайт Перспективы</a></li>
 	<li>затем загрузить и настроить Лейку.</li>
</ul>
<ol start="3">
 	<li>Если у вас уже есть параметры подключения к Хронопей, их нужно будет указать в настройках плагина (<a href="https://leyka.org/docs/chronopay/">инструкция по настройке Хронопей в Лейке</a>).</li>
</ol>
...
Но, если вам всё-таки понадобится помощь, вы можете запросить её на нашей платформе <a href="https://itvist.org/">it-волонтёр</a>.
...
О том, как подключиться к указанным системам, вы можете прочесть на <a href="https://leyka.org/instruction/">сайте Лейки, в разделе "инструкция"</a>',
        'menu_order' => 10,
        'meta' => array('ll_faq_show_on_main_page' => ''),
    ),
    array(
...
В этих случаях вам понадобится либо установить спец. плагин для редактирования прав доступа, либо вмешательство программиста (вы можете найти его, например, на нашем сервисе <a href="https://itvist.org/">it-волонтёр</a>',
        'menu_order' => 11,
        'meta' => array('ll_faq_show_on_main_page' => ''),
    ),
    array(
...
Вы можете заниматься ими параллельно.',
    ...
    array(
        ...
        'post_content' => 'Мы заинтересованы в поддержке всех платёжных систем, которые предлагают лояльные условия благотворительным и некоммерческим организациям. Если вы хотите интеграцию <a href="https://leyka.org/support/">напишите нам</a>.
...
Настройка коллбэков разная для каждого платёжного оператора. Детали обычно есть в документации по соответствующему оператору на сайте Лейки (<a href="https://leyka.org/instruction/">https://leyka.org/instruction/</a>). Например, для <a href="https://leyka.org/docs/podklyuchenie-cloudpayments/">CloudPayments</a> коллбэки – это:
<ul>
...
Кроме того, в настройках Лейки ("Настройки" – "Оповещения" – "Настройки уведомлений доноров при достижении целевой суммы кампании") должен быть текст этого письма и включен чекбокс "Отправлять письма".',
    ...
    array(
        ...
        'post_content' => 'Можно показать скриншот <a href="https://leyka.org/docs/lk/">личного кабинета</a>, в котором донор может управлять своими подписками:

<img class="alignnone size-full wp-image-3197" src="https://leyka.org/wp-content/uploads/2019/07/2019-07-16_22-00-00.png" alt="" width="631" height="820">
