...
<a href="http://leyka.org/wp-content/uploads/2014/01/Redaktirovat-kampaniyu-Onlajn-lejka-WordPress-plagin-dlya-kraudfandinga-i-sbora-pozhertvovanij-v-Seti-WordPress.png" data-imagelightbox="gallery-901"><img class="alignnone wp-image-901 size-full" src="https://leyka.org/wp-content/uploads/2014/01/Redaktirovat-kampaniyu-Onlajn-lejka-WordPress-plagin-dlya-kraudfandinga-i-sbora-pozhertvovanij-v-Seti-WordPress-e1435161194298.png" alt="Редактировать кампанию ‹ Онлайн лейка – WordPress плагин для краудфандинга и сбора пожертвований в Сети — WordPress" width="1177" height="2168" /></a>
...
Далее, мы можем выбрать шаблон формы пожертвования. Шаблон, который будет использоваться по умолчанию, мы выбирали при <a title="Настройка Лейки" href="https://leyka.org/nastrojka-lejki/">первичной настройке Лейки</a>. Если он по тем или иным причинам не устраивает, мы можем выбрать другой вариант. Разница между вариантами разъяснена на странице <a title="Настройка Лейки" href="https://leyka.org/nastrojka-lejki/">Настройка Лейки</a>.
...
<a href="https://leyka.org/wp-content/uploads/2014/01/grad.png" data-imagelightbox="gallery-832"><img class="alignnone size-medium wp-image-832" src="https://leyka.org/wp-content/uploads/2014/01/grad-640x69.png" alt="град" width="640" height="69" /></a>
...
<a class="fresco" href="https://leyka.org/wp-content/uploads/2014/01/Novaya-kampaniya-Lejka-razrabotka.png"><img class="alignnone size-medium wp-image-386" src="https://leyka.org/wp-content/uploads/2014/01/Novaya-kampaniya-Lejka-razrabotka-640x102.png" alt="Новая кампания   Лейка - разработка" width="640" height="102" data-id="386" /></a>
...
<a href="https://leyka.org/wp-content/uploads/2015/03/frejm.png" data-imagelightbox="gallery-824"><img class="alignnone size-medium wp-image-824" src="https://leyka.org/wp-content/uploads/2015/03/frejm-640x301.png" alt="фрейм" width="640" height="301" /></a>Скопируйте его и вставьте в любом месте на уже созданной странице. Следите за тем, чтобы вы вставляли код в режиме "текст" (режим html-разметки).
...
<img src="https://leyka.org/wp-content/uploads/2014/01/Lejka-Nastrojki-Lejka-razrabotka-WordPress-640x714.png" alt="Лейка  Настройки ‹ Лейка - разработка — WordPress" width="640" height="714" data-id="336" />
...
Нажмите "Сохранить"',
    ...
    array(
        ...
        'post_content' => 'Если при заполнении настроек "<a title="Настройка лейки: вкладка 2 «Платежные опции»" href="https://leyka.org/nastrojka-lejki-vkladka-2-platezhnye-optsii/">Платежные опции</a>" вы выбрали пункт - Яндекс.Деньги, то внизу вы увидите следующий блок. <a class="fresco" href="https://leyka.org/wp-content/uploads/2014/10/ya-k.png"><img class="alignnone size-medium wp-image-541" src="https://leyka.org/wp-content/uploads/2014/10/ya-k-640x415.png" alt="ya-k" width="640" height="415" data-id="541" /></a>
...
<a class="fresco" href="https://leyka.org/wp-content/uploads/2014/10/yand-kosh.png"><img class="alignnone size-medium wp-image-539" src="https://leyka.org/wp-content/uploads/2014/10/yand-kosh-640x342.png" alt="yand-kosh" width="640" height="342" data-id="539" /></a>
...
3) Скопируйте открывшийся код <a class="fresco" href="https://leyka.org/wp-content/uploads/2014/10/sekret.png"><img class="alignnone size-medium wp-image-546" src="https://leyka.org/wp-content/uploads/2014/10/sekret-640x304.png" alt="sekret" width="640" height="304" data-id="546" /></a>
...
Если вы<strong> официально оформленная НКО</strong> и хотите полностью обезопасить себя от государственных проверок, выбирайте способ подключения - <a href="https://leyka.org/yandex-dengi/">Яндекс.Деньги для юридических лиц</a>[/su_note]',
        'tax_terms' => array(
